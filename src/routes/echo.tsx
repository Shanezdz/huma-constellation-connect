...
export const Route = createFileRoute("/echo")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://huma-constellation-connect.vercel.app/echo" },
      {
        property: "og:image",
        content: "https://huma-constellation-connect.vercel.app/og/og-echo.jpg",
      },
      {
        name: "twitter:image",
        content: "https://huma-constellation-connect.vercel.app/og/og-echo.jpg",
    ...
    links: [{ rel: "canonical", href: "https://huma-constellation-connect.vercel.app/echo" }],
  }),
});
